...
class CNN:
    def __init__(self, action_dim,
        ...
        self.model = LeNet(self.m, use_seq=use_seq, num_bins=num_bins, robot_info_dim=robot_info_dim,
        ...
        # Old Policy network
        # ------------------------
        self.old_model = LeNet(self.m, use_seq=use_seq, num_bins=num_bins, robot_info_dim=robot_info_dim,
                               out_shift=out_shift, out_scale=out_scale, robot_info_shift=robot_info_shift,
                               robot_info_scale=robot_info_scale, use_late_fusion=use_late_fusion)
        if self.use_cuda:
            self.old_model.cuda()
...
class LeNet(nn.Module):
    def __init__(self, act_dim, use_seq=False, num_bins=0, robot_info_dim=None,
